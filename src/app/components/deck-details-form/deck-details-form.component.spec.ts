...
//   });
  ...
  // it('should log error with topics', () => {
  //   const topicService = TestBed.inject(TopicService);
  //   spyOn(topicService, 'getTopics').and.returnValues(throwError(() => new Error()));
  ...
  //   component.getAllTopics();
  //   fixture.detectChanges();
  //   expect(component.topicList.length).toEqual(1);
  //   expect(component.topicList[0].name).toEqual("Historia");
  // });
  //
  // // it('should log error with tags', () => {
  // //   const tagService = TestBed.inject(TagService);
  // //   spyOn(tagService, 'getTags').and.returnValues(throwError(() => new Error()));
  // //   let spy = spyOn(console, 'log');
  ...
  //   component.getAllTags();
  //   fixture.detectChanges();
  //   expect(component.allTagsList.length).toEqual(1);
  //   expect(component.allTagsList[0].name).toEqual("Historia");
  // });
  //
